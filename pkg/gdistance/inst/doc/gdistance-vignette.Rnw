...
The 3 x 3 raster we just created would have the cell numbers in the order shown if Figure 1.
...
Conductance could be thought of as the speed of movement, while the friction is the travel time employed to bridge the distance between the two cell centres.
