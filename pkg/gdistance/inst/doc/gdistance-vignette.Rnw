...
#rSPDistance(tr1Corr, sP, sP, theta=0.1)
@
...
The randomized shortest path distances are not directly comparable with the other distances, as they are scaled differently. 
